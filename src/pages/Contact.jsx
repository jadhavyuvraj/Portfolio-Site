...
export default function Contact() {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          setStatus("❌ Failed to send. Check console & EmailJS settings.");
        }
      );
  };

  const quickLinks = [
    { img: githubLogo, title: "GitHub", link: "https://github.com/jadhavyuvraj" },
    { img: linkedinLogo, title: "LinkedIn", link: "https://www.linkedin.com/in/yuvraj-jadhav-842141288/" },
    { img: gmailLogo, title: "Email", link: "mailto:yuvijadhav159@gmail.com" },
  ];
  ...
  return (
    <section className="contact-section">
      ...
      >
        If you love my portfolio please don't hesitate to reach out!
      </motion.p>
      ...
      >
        ...
        {status && (
          <motion.p initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="contact-status">
            {status}
          </motion.p>
        )}
      </motion.form>
